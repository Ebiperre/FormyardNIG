  ...
  return (
    <footer className="flexCenter bg-black text-white">
      ...
      >
        ...
        <div className="grid  gap-4 border-b">
          {/* footer items */}
            <div className="flex flex-col lg:flex-row justify-between text-start w-full  gap-3 py-12">
              ...
              <div className="flex flex-col text-[#BCBCBC] space-y-4 " >
        ...
        <div className="flex flex-col  lg:flex-row justify-between items-center lg:pb-4 pb-2 space-y-4  ">
          <div className="flex items-center text-[#BCBCBC]">
            <LiaCopyrightSolid />
            <p>2023 Formyard. All Rights Reserve</p>
          </div>
