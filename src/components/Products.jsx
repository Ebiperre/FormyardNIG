...
const Services = () => {
  return (
    <section className="mx-auto  px-28">
      ...
      <div className="grid grid-cols-4 gap-[23px] mt-8 ">
        {data.map((stat) => (
          <div className="flex flex-col place-content-center gap-[32px]    w-fit  ">
            <div></div>
            <div className="flex  items-center justify-center gap-4 w-[240px] h-[78px]  rounded-full  border border-black py-4 px-4 bg-red-100 ">
