  ...
  return (
    <>
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="w-full lg:w-1/2">
            <p className="font-normal text-[14px] md:text-[16px] md:text-left  text-center">
              ...
              The FORMYARD  LTD is excited to introduce "LEKKI BLUE WATERS
              2018," a project that exemplifies our relentless pursuit of
              excellence and forward-thinking. This initiative in the Lekki Blue
              Waters area represents a significant milestone in our journey to
              create sustainable and visionary developments. In "LEKKI BLUE
              WATERS 2018," we've combined cutting-edge design, eco-friendly
              practices, and community enhancement to craft a unique and vibrant
        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="w-full lg:w-1/2 text-center md:text-left">
            <p className="font-normal text-[14px] md:text-[16px] md:text-left  text-center">
              ...
              FORMYARD  LTD's PHC Training Program, SUDELETTRA Training 1, is
      ...
      <section className=" px-5 py-8 container lg:px-36 mx-auto space-y-2 ">
        <h2 className="text-xl">COMPLETED PROJECT</h2>
        <h2 className="font-bold">
          SERVICE ASSEMBLY OFFERED BY FORMYARD  LTD
        </h2>
        <div className="flex flex-col lg:flex-row gap-4">
          <div className="w-full lg:w-1/2 ">
          ...
          <div className="w-full lg:w-1/2">
            <p className="font-normal text-[14px] md:text-[16px] md:text-left  text-center">
              ...
              <br></br>{' '}
              <span className="font-bold"> PROJECT DESCRIPTION: </span>The
              FORMYARD LTD offers a comprehensive service assembly that
